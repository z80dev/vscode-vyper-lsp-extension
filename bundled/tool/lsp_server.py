...
# LSP_SERVER = server.LanguageServer(
    # name="vyperlsp", version="0.0.1", max_workers=MAX_WORKERS
# )

LSP_SERVER = vyper_lsp.server
...
if __name__ == "__main__":
    LSP_SERVER.show_message_log("Starting " + TOOL_DISPLAY + " Language Server")
    LSP_SERVER.start_io()
